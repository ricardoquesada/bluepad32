...
uint8_t uni_circular_buffer_is_empty(uni_circular_buffer_t* b) { return (b->head_idx == b->tail_idx); }
...
void uni_circular_buffer_reset(uni_circular_buffer_t* b) { b->head_idx = b->tail_idx = 0; }
